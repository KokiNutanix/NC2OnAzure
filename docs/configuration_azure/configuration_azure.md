...
Click Register on the top of the serach bar and those status will be shown as Registered shortly.
![](images/image1.png)
...
In order for NC2 to provision and manage clusters in Azure, you must create an App registarion with an appropriate role. Otherwise, NC2 fails to access to resources in Azure.
...
Go to Home, open the humberger memu and click Microsoft Entra ID.

Click an Add button, open the pull-down and click App registration.
![](images/image5.png)

Enter a name of the appliction and configure Supported accuont types and Redirect URI as you prefer (in this case leave these two as default).
![](images/image6.png)

Click a Register button.


### Asign the Azure Custom Role

Navigate to your subscription>Access control (IAM) and click an Add button to expand the pull-down and Add role assignment.
![](images/image7.png)
...
Now you completed to create an App regstration with the custom role.

The last thing to do here is to generate a client secret which is required to access to Azure resources for NC2.

Navigate to the humberger memu>Microsoft Entra ID>App regstrations and click your application.
![](images/image10.png)

Click "Add a certificate or secrete" located under Client credentials.
![](images/image11.png)

Click a New client secret and an Add button.
![](images/image12.png)

Be sure to save the seacret value (not secret ID) as the value cannot be viwed after leaving the page.
![](images/image13.png)